...
<form action="${actionUrl}" method="post" name="crudVO">
	...
	<input type="text" name="crudSj" value="${result.crudSj}" placeholder="제목을 입력하세요."/>
	<br/>
	...
	<textarea id="crudCn" name="crudCn" placeholder="내용를 입력하세요."><c:out value="${result.crudCn}"/></textarea>
	<br/>
	<c:choose>
		<c:when test="${not empty result.crudId}">
